...
export default function OrderSummary() {
  ...
  return (
    <div className="flex flex-col gap-6 rounded-[14px] bg-white p-6 shadow-sm md:p-7">
      <div className="font-headline text-[17px] font-extrabold text-neutral-900">Order summary</div>
      ...
      <div className="flex flex-col gap-3.5">
        ...
        <div className="flex justify-between text-sm text-neutral-700">
          ...
          <span className={deliveryFree && subtotal > 0 ? "font-bold text-secondary-600" : ""}>
            {subtotal === 0 ? "—" : deliveryFree ? "Free" : formatEGP(deliveryFee)}
          </span>
        </div>
        {promoApplied && (
      ...
      <div className="flex items-baseline justify-between">
        <span className="font-headline text-[15px] font-bold text-neutral-900">Total</span>
