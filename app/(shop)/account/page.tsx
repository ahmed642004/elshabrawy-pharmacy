    ...
    return (
      <main className="mx-auto flex w-full max-w-[960px] flex-1 flex-col px-4 py-6 md:px-6 md:py-10">
        <div className="flex flex-col items-center gap-3.5 rounded-[28px] border border-neutral-200 bg-white px-6 py-12 text-center">
          ...
          <div className="font-headline text-xl font-extrabold text-neutral-900">Sign in to your account</div>
          <div className="max-w-[320px] text-sm text-neutral-500">
            Manage your details, saved addresses, and orders in one place.
          </div>
          <Link href="/auth?redirect=/account">
  ...
  return (
    <main className="mx-auto flex w-full max-w-[720px] flex-1 flex-col gap-5 px-4 py-6 md:px-6 md:py-10">
      <div>
        ...
        <p className="m-0 mt-1 text-sm text-neutral-500">Your details, saved addresses, and orders</p>
      </div>
